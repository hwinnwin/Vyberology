          ...
          <div className="space-y-3 p-4 rounded-lg bg-muted/50">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <div className="text-center p-2 rounded bg-background">
                ...
                <div className="text-xs text-muted-foreground">{reading.left.numbers.soulUrgeDeep && reading.left.numbers.soulUrge.value !== reading.left.numbers.soulUrgeDeep.value ? "Active Soul" : "Soul"}</div>
              </div>
              {reading.left.numbers.soulUrgeDeep && reading.left.numbers.soulUrge.value !== reading.left.numbers.soulUrgeDeep.value && (
                <div className="text-center p-2 rounded bg-background">
                  <div className="text-lg font-bold text-primary">{reading.left.numbers.soulUrgeDeep.value}</div>
                  <div className="text-xs text-muted-foreground">Deep Soul</div>
                </div>
              )}
            </div>
          ...
          <div className="space-y-3 p-4 rounded-lg bg-muted/50">
            ...
            <div className="grid grid-cols-3 gap-2">
              ...
              <div className="text-center p-2 rounded bg-background">
                ...
                <div className="text-xs text-muted-foreground">{reading.right.numbers.soulUrgeDeep && reading.right.numbers.soulUrge.value !== reading.right.numbers.soulUrgeDeep.value ? "Active Soul" : "Soul"}</div>
              </div>
              {reading.right.numbers.soulUrgeDeep && reading.right.numbers.soulUrge.value !== reading.right.numbers.soulUrgeDeep.value && (
                <div className="text-center p-2 rounded bg-background">
                  <div className="text-lg font-bold text-primary">{reading.right.numbers.soulUrgeDeep.value}</div>
                  <div className="text-xs text-muted-foreground">Deep Soul</div>
                </div>
              )}
            </div>
