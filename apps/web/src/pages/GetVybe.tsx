...
import { Sparkles, Clock, Send, Hash, ArrowLeft, Home, Briefcase, Heart } from "lucide-react";
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="mb-8 relative z-10">
            ...
            <p className="text-lg text-lf-slate text-center">
              Enter numbers manually, chat with Lumyn, or explore frequency patterns
            </p>
          </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-4 mt-4 border-t border-white/10">
                      <p className="text-xs text-lf-slate text-center mb-3">
                        Deep AI-powered outlooks — free preview + premium readings
                      </p>
                      <div className="grid grid-cols-2 gap-3">
                        <Link
                          to="/career"
                          className="flex items-center justify-center gap-2 rounded-lg border border-lf-violet/30 bg-lf-midnight/50 px-3 py-3 text-sm font-medium text-white/80 hover:border-lf-aurora/50 hover:text-white hover:shadow-glow transition-all duration-200 no-underline"
                        >
              ...
              <div className="rounded-lg bg-lf-ink/40 p-4 border border-lf-aurora/20 hover:border-lf-aurora/50 transition-all">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-lf-slate">
                      Notice numbers you encounter — license plates, receipts, timestamps — and enter them here
                    </p>
                  </div>
                </div>
              </div>
