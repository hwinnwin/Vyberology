          ...
          <div className="prose prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside text-lf-slate space-y-2 mb-6">
                ...
                <li><strong className="text-white">Screenshots:</strong> If you use our "Hey Lumyn" voice assistant feature, you may capture screenshots containing numbers or text</li>
              </ul>
